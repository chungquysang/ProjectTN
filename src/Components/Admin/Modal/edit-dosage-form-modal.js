...
import { updateDosage } from "../../../services/API/DosageMedicine";


function Editdosge({ dosageForm, onClose, onSuccess }) {
  ...
  useEffect(() => {
    if (dosageForm) {
      setDosageFormName(dosageForm.dosageFormName || "");
    }
  }, [dosageForm]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await updateDosage(dosageForm.dosageFormId, dosageFormName.trim());
